# @protoform/adapter-material

Material UI (MUI) adapter for [ProtoForm](https://github.com/AlexanderCollins/protoform), the schema-driven form
protocol with identical client and server validation.

Community-maintained. Ships as-is and welcomes contributors.

```bash
npm install @protoform/core @protoform/react @protoform/adapter-material
```

```tsx
import { ProtoForm } from "@protoform/react";
import adapter from "@protoform/adapter-material";
